...
const Features = ({ title, features }: Props) => {
  ...
  return (
    <div className="p-8 flex flex-col items-center self-stretch gap-8 border-b border-slate-200">
      <div className="text-gray-900 font-inter text-xl font-semibold leading-6 w-full">
        {title}
      </div>

                ...
                <div className="md:flex">
                  <FadeIn className="md:w-full m-auto ">
                    ...
                    <p className="mt-6 text-xl md:text-start sm:text-center text-neutral-600 dark:text-neutral-300">
                      We are an end-to-end product development company, turning your ideas into products.
                      From architecture and design to building web & mobile apps, APIs, DevOps, deployments,
                      and Generative AI solutions, we create seamless, scalable products that drive success.
                    </p>

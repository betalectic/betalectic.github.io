            ...
            >
                  ...
                  <div className="md:flex">
                    <FadeIn className="md:w-full mx-auto flex flex-col gap-8 items-center md:items-start">
                      ...
                      <p className="text-xl md:text-start text-center text-neutral-600 dark:text-neutral-300 m-0">
                        ...
                        user-friendly{" "}
                        <span className="font-semibold">UX/UI</span>. Our
                        partnerships extend beyond launch - we stay as{" "}
                ...
                <div className="mt-32">
                  ...
                  >
                    <p className="text-base text-neutral-600 dark:text-neutral-300">
                      ...
                      <span className="font-bold"> #shipcentric</span> mindset.
                      We empower your businesses to scale, innovate, and thrive.
                      We provide end-to-end services from{" "}
                  ...
                  <Container className="mt-24">
                    <GridList>
                      ...
                      >
                        We build responsive, scalable web and mobile
                        applications tailored to your business needs and goals.
                      </GridListItem>
                      ...
                      <GridListItem title="Generative AI" icon={Icons.genAi2}>
                        We develop cutting-edge Generative AI solutions that
                        drive automation and deliver tailored, data-driven
                      ...
                      >
                        ...
                        visually appealing interfaces that enhance user
              ...
              /> */}
                ...
                <Testimonial className="mt-24 sm:mt-32 lg:mt-40">
                  ...
                  stage - helping you shape your vision, overcome challenges,
                  and get your app to market seamlessly.
                </Testimonial>
                {/* <Services /> */}
                <ContactSection />
              </main>

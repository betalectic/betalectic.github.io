      ...
      <>
        ...
        >
          <div className="flex-col">
            <Icons.webMobile />
            <p className="font-bold text-xs">Web & Mobile</p>
          </div>
        </OrbitingCircles>
        <OrbitingCircles
          className="size-[50px] border-none bg-transparent"
        ...
        >
          <div className="flex-col">
            <Icons.api />
            <p className="font-bold text-xs">APIs</p>
          </div>
        </OrbitingCircles>
        ...
        >
          <div className="flex-col">
            <Icons.bfsi />
            <p className="font-bold text-xs">BSFI</p>
          </div>
        </OrbitingCircles>
        <OrbitingCircles
          className="size-[50px] border-none bg-transparent"
        ...
        >
          <div className="flex-col">
            <Icons.devOps />
            <p className="font-bold text-xs">DevOps</p>
          </div>
        </OrbitingCircles>
        <OrbitingCircles
          className="size-[50px] border-none bg-transparent"
        ...
        >
          <div className="flex-col">
            <Icons.genAi />
            <p className="font-bold text-xs">Gen AI</p>
          </div>
        </OrbitingCircles>
      </>
    </div>
